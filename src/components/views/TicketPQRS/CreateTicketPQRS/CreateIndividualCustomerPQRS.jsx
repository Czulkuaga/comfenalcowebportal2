...
const CreateIndividualCustomerPQRS = () => {
  //RegExp
  ...
  const postData = async (formData) => {
    ...
    if (requestDataCustomer.FirstName === "" ||
      requestDataCustomer.LastName === "" ||
      requestDataCustomer.FechadeNacimiento_KUT === "" ||
      requestDataCustomer.GenderCode === "" ||
      requestDataCustomer.Mobile === "" ||
      ...
      let isValidEmail = requestDataCustomer.Email.match(validEmail)
          ...
          <div className='comf-container'>
            <div className=''>
              <div className='comf-col-12 container-text-informativo'>
                <h2>Creación como cliente de Comfenalco Antioquia</h2>
                <p className='comf-subtitulo'>En esta ventana te podrás registrar como cliente de Comfenalco Antioquia para radicar un PQRSF.</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className='card-main'>
                {
                  loading ?
                    ...
                    :
                    (
                      <form ref={formCreateTicket} className='search-corredor' onSubmit={(e) => handleSubmit(e)}>
                                ...
                                Object.keys(errors).length !== 0 ?
                                  (
                                    <div>
                                      ...
                                      <button className='btn-submit-search  margin-auto' type='button' readOnly>Crear Cliente</button>
                                    </div>
                                  )
                                  :
                                  (
                                    <div>
                                      ...
                                      <button className='btn-submit-search  margin-center' type='submit'>Crear Cliente</button>
                                    </div>
                                  )
                              }
                            </div>
...
export default CreateIndividualCustomerPQRS
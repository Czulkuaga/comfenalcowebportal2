          ...
          <div className='comf-container'>
            <div className='comf-row'>
              <div className='comf-col-12 container-text-informativo'>
                <h2>Creación como cliente Corporativo de Comfenalco Antioquia</h2>
                <p className='comf-subtitulo'>En esta ventana te podrás registrar como cliente Corporativo de Comfenalco Antioquia para radicar un PQRSF.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className='components-main'>
            <div className='cart-component'>
              ...
              <div className='cart-header margin-center'>
                <h2 className='title-form'>Ingresa los siguientes datos de contacto</h2>
                {
                  formError && <h4 className='errorForm'>Error al crear el cliente, intenta nuevamente o contáctanos a través de nuestra línea 6044447110.</h4>
                }
              </div>
                            ...
                            <div className='fila-col '>
                              <div className='position-relative'>
                                ...
                                <div className={'form-component'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.numberIdentification} type='string' id='number-identification' name='number-identification' readOnly={true} className='number-identification input-form disabledTextInput' />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className='fila-col '>
                              <div className='position-relative'>
                                <div className={!errors.razonSocial ? 'form-component' : 'form-component form-component-error'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.razonSocial} type='string' id='razonSocial' name='razonSocial' className='razon-social input-form' />
                                </div>
                                {
                            ...
                            <div className='fila-col '>
                              <div className='position-relative'>
                                <div className={!errors.firstName ? 'form-component' : 'form-component form-component-error'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.firstName} type='string' id='firstName' name='firstName' className='primer-apellido input-form' />
                                </div>
                                {
                            ...
                            <div className='fila-col'>
                              <div className='position-relative'>
                                <div className={!errors.lastName ? 'form-component' : 'form-component form-component-error'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.lastName} type='string' id='lastName' name='lastName' className='segundo-apellido input-form' />
                                </div>
                                {
                            ...
                            <div className='fila-col '>
                              <div className='position-relative'>
                                ...
                                <div className={!errors.numIdentContacto ? 'form-component' : 'form-component form-component-error'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.numIdentContacto} type='string' id='numIdentContacto' name='numIdentContacto' className='genero input-form' />
                                </div>
                                {
                            ...
                            <div className='fila-col '>
                              <div className='position-relative'>
                                ...
                                <div className={!errors.emailUser ? 'form-component' : 'form-component form-component-error'}>
                                  ...
                                  <input onChange={(e) => inputChangeHandler(e)} value={formDataInfo.emailUser} type='email' id='email' name='email' className='email input-form' />
                                </div>
                                {
...
export default CreateCorporatePQRS
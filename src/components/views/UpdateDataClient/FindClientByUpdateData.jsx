    ...
    const getTipoIdentificacion = async () => {
        try {
            ...
            if (response.code === 'success') {
                let newArray = response.identificationType.filter((ident) => ident.identificador !== "NIT" &&  ident.identificador !== "NOP")
                setTipoIdentificacion(newArray)
                newArray.map((tipo) => (
                    rows.push(tipo)
                ))
            }
                    ...
                    <div className='comf-container'>
                        <div className=''>
                            <div className='comf-col-12 container-text-informativo'>
                                ...
                                <p className='comf-subtitulo'>Ingresa y actualiza tus datos como cliente.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className='components-main'>
                        <div className='cart-component'>
                            <div className='cart-header'>
                                <h2 className='title-form'>Consulta con documento de identidad.</h2>
                                {
...
export default FindClientByUpdateData